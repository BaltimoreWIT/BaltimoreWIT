<?php
	...
	$pageTitle = "Careers";
	// $metaDesc = "";
	$ogTitle = "Career Info and Opportunities from Baltimore Women in Tech";
	// $ogType = "article";
	$ogImage = "http://baltimorewomenintech.com/images/bwit_logotext_li.png";
	$ogURL = "http://baltimorewomenintech.com/careers/";
	include "header.php";
?>
			...
			<main>
				<article>
					<header class="articleHeader">
						<h1 class="articleHeadline">Careers</h1>
					</header>
						...
						<footer class="articleFooter">
							<div class="shareWrapper">
								...
								<ul class="socialWrapper">
									<li>
										<a href="http://twitter.com/intent/tweet?text=Tech+Career+Info%2C+Mentorship+and+Opportunities+via+@baltimorewit+%23bmorewit&url=http:%2F%2Fbaltimorewomenintech.com%2Fcareers" target="_blank" title="Share this on Twitter">
									...
									<li><a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//baltimorewomenintech.com/careers" target="_blank" title="Share this on Facebook">
