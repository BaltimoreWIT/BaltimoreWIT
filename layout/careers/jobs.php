			...
			<main>
				<article>
					<header class="articleHeader">
						<h1 class="articleHeadline">Jobs</h1>
					</header>
						...
						<footer class="articleFooter">
							<div class="shareWrapper">
								...
								<ul class="socialWrapper">
									<li>
										<a href="http://twitter.com/intent/tweet?text=Tech+and+Dev+Career+Info+and+Opportunities+via+@baltimorewit+%23bmorewit&url=http:%2F%2Fbaltimorewomenintech.com%2Fcareers%2Fjobs" target="_blank" title="Share this on Twitter">
