			...
			<main>
				<article>
					<header class="articleHeader">
						<h1 class="articleHeadline">2016 Blog Posts</h1>
					</header>
						<div class="articleContent">
							<ul class="noList archiveList">
								<li><a href="blog-title">Blog Title</a> <span class="meta"><span>by</span> Author Name</span></li>
								<li><a href="blog-title">Blog Title</a> <span class="meta"><span>by</span> Author Name</span></li>
							</ul>
							<a href="../">&larr; View All Blog Posts</a>
						</div>
						<footer class="articleFooter">
							<div class="shareWrapper">
								...
								<ul class="socialWrapper">
									<li>
										<a href="http://twitter.com/intent/tweet?text=Baltimore+Women+In+Tech+Blogs+via+@baltimorewit+%23bmorewit&url=http:%2F%2Fbaltimorewomenintech.com%2Fblog%2F2016" target="_blank" title="Share this on Twitter">
									...
									<li><a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//baltimorewomenintech.com/blog/2016" target="_blank" title="Share this on Facebook">
