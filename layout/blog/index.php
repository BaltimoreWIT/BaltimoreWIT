<?php
	...
	// $metaDesc = "";
	$ogTitle = "Baltimore Women in Tech Blog Posts";
	// $ogType = "article";
	$ogImage = "http://baltimorewomenintech.com/images/bwit_logotext_li.png";
	$ogURL = "http://baltimorewomenintech.com/blog/";
	include "header.php";
?>
			...
			<main>
				<article>
					<header class="articleHeader">
						<h1 class="articleHeadline">Blog Posts</h1>
					</header>
						<div class="articleContent">
							<ul class="noList archiveList">
								<li><a href="2016/blog-title">Blog Title</a>&mdash;<span class="meta"><span>by</span> Author Name</span></li>
								<li><a href="2016/blog-title">Blog Title</a>&mdash;<span class="meta"><span>by</span> Author Name</span></li>
							</ul>
						</div>
						<footer class="articleFooter">
							<div class="shareWrapper">
								...
								<ul class="socialWrapper">
									<li>
										<a href="http://twitter.com/intent/tweet?text=Baltimore+Women+In+Tech+Blog+Posts+via+@baltimorewit+%23bmorewit&url=http:%2F%2Fbaltimorewomenintech.com%2Fblog" target="_blank" title="Share this on Twitter">
									...
									<li><a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//baltimorewomenintech.com/blog" target="_blank" title="Share this on Facebook">
