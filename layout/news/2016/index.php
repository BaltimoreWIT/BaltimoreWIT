			...
			<main>
				<article>
					<header class="articleHeader">
						<h1 class="articleHeadline">2016 News</h1>
					</header>
						<div class="articleContent">
						<ul class="noList archiveList">
							<li><a href="hellobaltimore.php">#hellobaltimore</a>&mdash;<span class="meta"><span>published on</span> February 28, 2016</span></li>
						</ul>
						</div>
