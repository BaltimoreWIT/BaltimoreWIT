<?php
	...
	$pageTitle = "Community";
	// $metaDesc = "";
	$ogTitle = "Baltimore Women in Tech Community";
	// $ogType = "article";
	$ogImage = "http://baltimorewomenintech.com/images/bwit_logotext_li.png";
	$ogURL = "http://baltimorewomenintech.com/community/";
	include "header.php";
?>
						...
						<footer class="articleFooter">
							<div class="shareWrapper">
								...
								<ul class="socialWrapper">
									<li>
										<a href="http://twitter.com/intent/tweet?text=%23Baltimore+Community+Events+and+Resources+via+@baltimorewit+%23bmorewit&url=http:%2F%2Fbaltimorewomenintech.com%2Fcommunity" target="_blank" title="Share this on Twitter">
									...
									<li><a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//baltimorewomenintech.com/community" target="_blank" title="Share this on Facebook">
