<?php
	...
	// $metaDesc = "";
	$ogTitle = "Baltimore Women in Tech Code of Conduct";
	$ogType = "article";
	$ogImage = "http://baltimorewomenintech.com/images/bwit_logotext_li.png";
	$ogURL = "http://baltimorewomenintech.com/community/codeofconduct/";
	include "header.php";
?>
						...
						<footer class="articleFooter">
							<div class="shareWrapper">
								...
								<ul class="socialWrapper">
									<li>
										<a href="http://twitter.com/intent/tweet?text=Baltimore+Women+In+Tech+Code+of+Conduct+via+@baltimorewit+%23bmorewit&url=http:%2F%2Fbaltimorewomenintech.com%2Fcommunity%2Fcodeofconduct" target="_blank" title="Share this on Twitter">
									...
									<li><a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//baltimorewomenintech.com/community/codeofconduct" target="_blank" title="Share this on Facebook">
